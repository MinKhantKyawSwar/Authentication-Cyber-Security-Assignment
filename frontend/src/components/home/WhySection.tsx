  ...
  return (
    <div className="mb-20 w-full px-4 sm:px-6">
      ...
      <div className="flex flex-col items-center gap-6 sm:gap-10 text-center mt-16 sm:mt-32">
        <h2 className="text-2xl sm:text-3xl h-14 md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 via-pink-500 to-rose-500 leading-snug">
          Why Cybersecurity Matters
        </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-10 mt-6 sm:mt-10 w-full ">
          <SpotlightBox>
            <div className="p-5 sm:p-6 rounded-2xl shadow-lg">
          ...
          <SpotlightBox>
            <div className="p-5 sm:p-6 rounded-2xl shadow-lg">
              ...
              <p className="text-neutral-700 text-sm sm:text-base">
                Maintain your users’ confidence by securing accounts and
                personal data.
              </p>
            </div>
          </SpotlightBox>
